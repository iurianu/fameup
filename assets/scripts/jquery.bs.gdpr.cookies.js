...
(function($) {
    ...
    $.fn.bsgdprcookies = function(options, event) {
        ...
        var settings = $.extend({
            ...
            class: '',
            title: 'Inovatie Alia\'s website, available at www.fameup.net, uses Cookies',
            backdrop: 'static',
            message: 'You can chose which cookies you want to accept!',
            ...
            advancedTitle: 'Customize your cookie settings!<br><p style="font-size: 16px">The cookies marked as necessary are required for the site to work properly. <br>If we have your consent following you ticking the below boxes, the Website can also use preferences cookies, statistics cookies and/or marketing cookies.</p>',
            ...
            advancedCookiesToSelect: [
                ...
                },
                {
                    name: 'marketing',
                    title: 'Marketing',
                    description: 'Required for marketing, e.g. newsletters, social media, etc',
                    isFixed: false
                }
            ],
            OnAccept: function() {}
        ...
        if(!cookieShow || !cookiePreferences || event == 'reinit') {
            ...
            if(settings.allowAdvancedOptions === true) {
                ...
                modalBody = '<div id="' + settings.id + '-message">' + settings.message + moreLink + '</div>' + '<div id="' + settings.id + '-advanced-types" style="display:none; margin-top: 10px;"><h5 id="' + settings.id + '-advanced-title">' + settings.advancedTitle + '</h5><ul>' + advancedCookiesToSelectList + '</ul><br><p style="font-size: 16px">For more information, please consult our Cookie Policy available <a href="privacy.html" target="_blank" rel="tag">here</a></p></div>';
            }
            else {
